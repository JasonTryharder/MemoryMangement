...
//// STUDENT CODE
////
ChatBot::ChatBot(const ChatBot &source)// copy Constructor // task 2
{
...
ChatBot &ChatBot::operator=(const ChatBot &source)// copy assignment operator // task 2
{
    if (this == &source)
    return *this;
    delete _image;
...
ChatBot::ChatBot(ChatBot &&source) // move constructor ,input is rvalue //task 2
{
    _image = source._image;
    _chatLogic = source._chatLogic;
    _chatLogic->SetChatbotHandle(this);
    _rootNode = source._rootNode;
    _currentNode = source._currentNode;
    source._image = NULL; // wxWidgets used NULL 
...
ChatBot &ChatBot::operator= (ChatBot &&source) // move assignment operator //task 2
{
    if (this == &source)
    return *this;
    // delete[] _image; // _image is not an array, hence use the delete
    delete _image; 
    _image = NULL;
