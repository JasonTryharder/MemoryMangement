...
private:
    ...
    //// STUDENT CODE
    ////
    // task 1 _chatLogic exclusive to ChatBotPanelDialog
...
public:
    ...
    //task 1 the problem here is that the return value is expected to be an ordinary pointer, so to return such a pointer you have to extract it via the get method from the unique pointer you have at hand.
